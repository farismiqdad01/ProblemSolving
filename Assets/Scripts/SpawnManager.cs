...
public class SpawnManager : MonoBehaviour
{
    ...
    IEnumerator SpawnKotak()
    {
        if (transform.childCount < 10)
        {
            ...
            GameObject Meteor = Instantiate(kotakPrefabs, new Vector2(randomX, randomY), Quaternion.identity) as GameObject;
            Meteor.transform.SetParent(GameObject.FindGameObjectWithTag("Spawn").transform, false);
        }
